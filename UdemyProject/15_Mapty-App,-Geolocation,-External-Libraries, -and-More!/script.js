...
class Workout {
  date = new Date();
  id = (Date.now() + '').slice(-10); // Time stamp in mili.Sec
  clicks = 0;
...
class App {
  ...
  _newWorkout(e) {
    ...
    const distance = +inputDistance.value; // '+' will convert input to the Number
    ...
    // Rendor workout on map as marker
  ...
  _renderWorkoutList(workout) {
    ...
    if (workout.type === 'running') {
      ...
      <div class="workout__details">
            ...
            <span class="workout__value workout__running--pace">${workout.pace.toFixed(
              1
            )}</span>
          ...
          <div class="workout__details">
            <span class="workout__icon">🦶🏼</span>
            <span class="workout__value workout__running--cadence">${
              workout.cadence
            }</span>
    ...
    if (workout.type === 'cycling') {
      ...
      <div class="workout__details">
            <span class="workout__icon">⚡️</span>
            <span class="workout__value workout__cycling--speed">${workout.speed.toFixed(
              1
            )}</span>
            <span class="workout__unit">min/km</span>
          </div>
          <div class="workout__details">
            <span class="workout__icon">🦶🏼</span>
            <span class="workout__value workout__cycling--elevation">${
